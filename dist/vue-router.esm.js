...
var View = {
  ...
  render: function render (_, ref) {
    ...
    var name = props.name;
    var route = standaloneRouter ? fakeApp.$route : parent.$route;
...
var Link = {
  ...
  render: function render (h) {
    ...
    var router = this.routerName ? this.$root._extraRouters[this.routerName] : this.$router;
    var current = this.routerName ? this.$root._extraRouters[this.routerName].app.$route : this.$route;
