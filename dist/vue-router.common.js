...
var Link = {
  ...
  render: function render (h) {
    ...
    var router = this.routerName ? this.$extraRouters[this.routerName] : this.$router;
    var current = router.app.$route;
...
function install (Vue) {
  ...
  Object.defineProperty(Vue.prototype, '$extraRouters', {
    get: function get () { return this._routerRoot._extraRouters }
  });
